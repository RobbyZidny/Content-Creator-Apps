                ...
                <div className="flex gap-4 items-center">
                    ...
                    <Link href="/profile">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-primary to-secondary p-[2px] cursor-pointer hover:scale-105 transition-transform">
                            <img src={avatarImage.src} alt="Profile" className="w-full h-full rounded-full object-cover bg-black" />
                        </div>
                    </Link>
                </div>
            </header>
                        ...
                        <div className="px-4 py-3 flex justify-between items-center">
                            <div className="flex items-center gap-3 cursor-pointer">
                                <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-primary/50 to-secondary/50 p-[1.5px]">
                                    <img src={typeof post.avatar === 'string' ? post.avatar : post.avatar.src} alt={post.user} className="w-full h-full rounded-full object-cover bg-black border-2 border-black" />
                                </div>
                                <div>
