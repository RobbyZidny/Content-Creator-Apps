...
import { Calendar, Sparkles, BarChart2, Users, Link as LinkIcon, PenTool, Lightbulb, UserPlus, Rocket, Wrench, Clock, DollarSign, Image as ImageIcon } from "lucide-react";
                        ...
                        >
                            {tool.image ? (
                                <div className="w-16 h-16 mb-2 relative">
                                    ...
                                    <img src={typeof tool.image === 'string' ? tool.image : tool.image.src} alt={tool.title} className="w-full h-full object-contain relative z-10" />
                                </div>
                            ) : (
